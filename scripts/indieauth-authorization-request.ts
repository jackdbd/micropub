  ...
  const { values } = parseArgs({
    ...
    options: {
      'code-verifier-length': {
        type: 'string',
        default: String(DEFAULT.CODE_VERIFIER_LENGTH)
      },
      'client-id': { type: 'string', default: DEFAULT.CLIENT_ID },
      me: { type: 'string', default: DEFAULT.ME_BEFORE_CANONICALIZATION },
      'redirect-uri': { type: 'string', default: DEFAULT.REDIRECT_URI },
