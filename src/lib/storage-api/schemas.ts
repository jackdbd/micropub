...
export {
  ...
  type AuthorizationCodeImmutableRecord,
  type AuthorizationCodeMutableRecord
} from './authorization-code.js'

export {
  client_application_immutable_record,
  client_application_mutable_record,
  type ClientApplicationImmutableRecord,
  type ClientApplicationMutableRecord
...
export {
  ...
  type UserProfileImmutableRecord,
  type UserProfileMutableRecord
